...
general_config.eval_freq                = 1         # uint: frequency to evaluate models with (0 = disabled)
general_config.log_freq                 = 'epoch'   # str: frequency to log with ('' = disabled); options are ['batch', 'epoch', '']
...
model_config.epsilon                    = 1e-8      # float: small constant for numerical stability in PixelNormalization as well as StandardDeviation layers
...
train_config.epochs                     = 540       # uint: number of epochs to train for
...
data_config.replica_batch_sizes         = {2: 16, 3: 16, 4: 16, 5: 16, 6: 16, 7: 16, 8: 14, 9: 6, 10: 3}  # dict: batch_size at stage
